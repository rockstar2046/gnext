...
public interface GenericDao<E,PK extends Serializable> {
	 ...
	 * @return
	 */
	List<?> query(final String sql,final int firstResult,final int maxResults, final Object... values);
	/**
	 * Sql Query
	 * @param sql
	 * @param firstResult
	 ...
	 * @return
	 */
	List<?> query(final String sql,final int firstResult,final int maxResults, final Map<String, Object> values);
	/**
	 * Sql Query
	 * 
	 * @param sql
